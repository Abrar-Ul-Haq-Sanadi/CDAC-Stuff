...
int main()
{
    PrinterScanner *ps  = new PrinterScanner("Dell", "500 ppm", "450 * 450", "Printer");          // object of Printer(child class) is created and given refernce throught the Product(Parent Class)
